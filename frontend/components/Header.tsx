...
import { Menu,  VideoIcon, Bell, Mic, Search, UserCircle, } from "lucide-react";
...
import Channeldialogue from "./Channeldialouge";
...
const Header = () => {
  ...
  return (
    <header className="flex items-center justify-between px-4 py-2 bg-white border-b h-12">
      <div className="flex items-center gap-4">
        ...
        <Link href="/" className="flex items-center gap-1">
          ...
          <span className="text-xs text-gray-600 ml-1">IN</span>
        </Link>
      </div>
      <form
